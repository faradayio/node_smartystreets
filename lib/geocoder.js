...
var request = require('request').forever({maxSockets: 1024});
...
var geocodeChunk = function(item, queue, progress, addColumns, options, callback){
  var rows = item.rows;
  item.tries++;
...
module.exports = function(opts){
  ...
  var geocodingQueue = async.queue(function(chunk, callback){
    geocodeChunk(chunk, geocodingQueue, progress, addColumns, options, callback);
  }, options.concurrency);
